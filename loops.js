...
for (let i = 09 ; i < 19; i++) {
    if (i === 10) {console.log(( i + ":00") + ' Koffiepauze!');}
    else if (i === 12) {console.log(( i + ":00") + ' Lunchpauze!');}
    else if (i === 14) {console.log(( i + ":00") + ' Koffiepauze!');}
    else if (i === 17) {console.log(( i + ":00") + ' Bijna klaar...');}
